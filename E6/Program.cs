...
namespace E6
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Quanto tempo você gastou na viagem (horas): ");
            ...
            Console.WriteLine($"A distância ate o destino final é: {distância:F2} KM\n");//:F2 usado para definir uma aproximação decimal de 2 números apos virgula
